...
// === LÓGICA DE FILTRADO POR PENDIENTE DE ENVÍO ===
if ($filtro_envio === 'PENDIENTE') {
    $where_of[] = "o.enviado_correo = 0 AND o.estado_validacion = 'APROBADO'";
    $where_co[] = "0=1"; // Las constancias no entran en este filtro según tu DB
}
...
if ($fecha_fin !== '') {
    ...
    $where_co[] = "c.fecha_emision <= ?"; $params_co[] = $fecha_fin;
}
